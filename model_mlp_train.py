...
def train_mlp(target_column_name, original_name_dataset, smote, model_filename_requested_by_user):
    ...
    error_smote = load(f'./data_transformation/joblibs/{original_name_dataset}/etl/error_smote.joblib')
    ...
    def plot_result(x_label, y_label, plot_title, train_data, val_data):
        ...
        plt.legend()
        plt.grid(True)
        plt.savefig(f'./data_transformation/joblibs/{original_name_dataset}/model/mlp/k_cross_plot.png')
        #plt.show()
