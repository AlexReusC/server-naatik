...
def transform_df_predict(original_name_dataset, file_to_predict):
    ...
    drop_column_names = load(f'./data_transformation/joblibs/{original_name_dataset}/etl/drop_columns_names.joblib')
    encoder = load(f'./data_transformation/joblibs/{original_name_dataset}/etl/encoder.joblib')
    imp_mean = load(f'./data_transformation/joblibs/{original_name_dataset}/etl/imputation.joblib')
    df_mean_std = load(f'./data_transformation/joblibs/{original_name_dataset}/etl/mean_std.joblib')
